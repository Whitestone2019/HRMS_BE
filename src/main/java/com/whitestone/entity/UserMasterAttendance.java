...
@Entity
@Table(name = "USER_MASTER_ATTENDANCE_TBL", schema = "HRMSUSER")
...
public class UserMasterAttendance {
	...
	public String toString() {
		return "UserMasterAttendance [srlnum=" + srlnum + ", userid=" + userid + ", attendanceid=" + attendanceid
	...
	public UserMasterAttendance(Long srlnum, String userid, String attendanceid, Date attendancedate, String status,
