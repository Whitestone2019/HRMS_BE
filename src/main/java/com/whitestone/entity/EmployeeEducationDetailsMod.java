...
public class EmployeeEducationDetailsMod {
	...
	public String toString() {
		return "EmployeeEducationDetailsMod [srlnum=" + srlnum + ", userid=" + userid + ", regnum=" + regnum
				+ ", institution=" + institution + ", qualification=" + qualification + ", fieldofstudy=" + fieldofstudy
				+ ", percentage=" + percentage + ", yearofgraduation=" + yearofgraduation + ", additionalnotes="
				+ additionalnotes + ", duration=" + duration + ", delflg=" + delflg + ", rcreuserid=" + rcreuserid
				...
				+ getUserid() + ", getRegnum()=" + getRegnum() + ", getInstitution()=" + getInstitution()
				+ ", getQualification()=" + getQualification() + ", getFieldofstudy()=" + getFieldofstudy()
				+ ", getPercentage()=" + getPercentage() + ", getYearofgraduation()=" + getYearofgraduation()
				+ ", getAdditionalnotes()=" + getAdditionalnotes() + ", getDuration()=" + getDuration()
	...
	public EmployeeEducationDetailsMod() {
		super();
