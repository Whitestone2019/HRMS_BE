...
@Entity
@Table(name = "USER_ROLE_MENU_MAINTENANCE_TBL", schema = "HRMSUSER")
@JsonIgnoreProperties(ignoreUnknown = true)
public class UserRoleMenuMaintenance {
    @Id
	...
	public String toString() {
		return "UserRoleMenuMaintenance [mappingid=" + mappingid + ", roleid=" + roleid + ", menuid=" + menuid
	...
	public UserRoleMenuMaintenance(String mappingid, String roleid, String menuid, String permissions, String status,
	...
	public UserRoleMenuMaintenance() {
		super();
