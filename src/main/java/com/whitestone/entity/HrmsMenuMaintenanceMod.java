...
@Entity
@Table(name = "HRMS_MENU_MAINTENANCE_MOD_TBL", schema = "HRMSUSER")
@JsonIgnoreProperties(ignoreUnknown = true)
public class HrmsMenuMaintenanceMod {
    @Id
	...
	public String toString() {
		return "HrmsMenuMaintenanceMod [menuid=" + menuid + ", menuname=" + menuname + ", description=" + description
	...
	public HrmsMenuMaintenanceMod(String menuid, String menuname, String description, String parentmenuid,
			String urlpath, String icon, String menuorder, String entitycreflg, String delflg, String rcreuserid,
