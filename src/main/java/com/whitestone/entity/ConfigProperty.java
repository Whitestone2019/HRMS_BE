...
@Entity
@Table(name = "CONFIG_PROPERTY_TBL", schema = "HRMSUSER")
...
public class ConfigProperty {
	...
	public String toString() {
		return "ConfigProperty [sno=" + sno + ", propertytype=" + propertytype + ", propertycode=" + propertycode
	...
	public ConfigProperty(Long sno, String propertytype, String propertycode, String propertydesc, Date rcretime,
