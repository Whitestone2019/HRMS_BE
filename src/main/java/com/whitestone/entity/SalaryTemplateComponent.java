...
public class SalaryTemplateComponent {
    ...
    @Column(name = "is_payroll_deduction")
    private Boolean isPayrollDeduction;
   
    @Column(name = "is_deduction")
    private boolean isDeductionFlag;
   
    @Column(name = "is_other_allowance")
    private boolean isOtherAllowanceFlag;
    ...
    public Boolean getIsPayrollDeduction() {
        return isPayrollDeduction;
    }
 
    public void setIsPayrollDeduction(Boolean isPayrollDeduction) {
        this.isPayrollDeduction = isPayrollDeduction;
    }
 
    public boolean isDeductionFlag() {
        return isDeductionFlag;
    }
 
    public void setIsDeductionFlag(boolean isDeductionFlag) {
        this.isDeductionFlag = isDeductionFlag;
    }
 
    public boolean isOtherAllowanceFlag() {
        return isOtherAllowanceFlag;
    }
 
    public void setIsOtherAllowanceFlag(boolean isOtherAllowanceFlag) {
        this.isOtherAllowanceFlag = isOtherAllowanceFlag;
    }
