...
@Entity
@Table(name = "EMPLOYEE_ADDRESS_TBL", schema = "HRMSUSER")
...
public class EmployeeAddress {
    ...
    @Column(name = "PRESENT_CITY", length = 200)
    private String presentcity;

    @Column(name = "PRESENT_STATE", length = 200)
    private String presentstate;

    @Column(name = "PRESENT_COUNTRY", length = 100)
    private String presentcountry;

    @Column(name = "PRESENT_POSTAL_CODE", length = 100)
    ...
    @Column(name = "PERMANENT_CITY", length = 200)
    private String permanentcity;

    @Column(name = "PERMANENT_STATE", length = 200)
    private String permanentstate;

    @Column(name = "PERMANENT_COUNTRY", length = 100)
    private String permanentcountry;

    @Column(name = "PERMANENT_POSTAL_CODE", length = 100)
	...
	public String toString() {
		return "EmployeeAddress [userid=" + userid + ", presentaddressline1=" + presentaddressline1
				...
				+ ", rvfytime=" + rvfytime + ", getUserid()=" + getUserid() + ", getPresentaddressline1()="
				+ getPresentaddressline1() + ", getPresentaddressline2()=" + getPresentaddressline2()
				+ ", getPresentcity()=" + getPresentcity() + ", getPresentstate()=" + getPresentstate()
				+ ", getPresentcountry()=" + getPresentcountry() + ", getPresentpostalcode()=" + getPresentpostalcode()
				+ ", getPermanentaddressline1()=" + getPermanentaddressline1() + ", getPermanentaddressline2()="
				+ getPermanentaddressline2() + ", getPermanentcity()=" + getPermanentcity() + ", getPermanentstate()="
				+ getPermanentstate() + ", getPermanentcountry()=" + getPermanentcountry()
				+ ", getPermanentpostalcode()=" + getPermanentpostalcode() + ", getEntitycreflg()=" + getEntitycreflg()
	...
	public EmployeeAddress(String userid, String presentaddressline1, String presentaddressline2, String presentcity,
			...
			String permanentpostalcode, String entitycreflg, String delflg, String rcreuserid, Date rcretime,
