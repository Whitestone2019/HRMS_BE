...
@Entity
@Table(name = "USER_ROLE_MAINTENANCE_MOD_TBL", schema = "HRMSUSER")
@JsonIgnoreProperties(ignoreUnknown = true)
public class UserRoleMaintenanceMod {
    @Id
	...
	public String toString() {
		return "UserRoleMaintenanceMod [roleid=" + roleid + ", rolename=" + rolename + ", description=" + description
				...
				+ ", rmodtime=" + rmodtime + ", rvfyuserid=" + rvfyuserid + ", rvfytime=" + rvfytime + ", getRoleid()="
				+ getRoleid() + ", getRolename()=" + getRolename() + ", getDescription()=" + getDescription()
	...
	public UserRoleMaintenanceMod(String roleid, String rolename, String description, String permissions, String status,
