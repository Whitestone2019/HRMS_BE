...
@Entity
@Table(name = "EMPLOYEE_PROFILE_TBL", schema = "HRMSUSER")
...
public class EmployeeProfile {
    ...
    @Column(name = "PARENT_MOB_NUM", nullable = false, length = 30)
	...
	public String toString() {
		return "EmployeeProfile [userid=" + userid + ", empid=" + empid + ", employeename=" + employeename
	...
	public EmployeeProfile(String userid, String empid, String employeename, Date dateofbirth, String bloodgroup,
